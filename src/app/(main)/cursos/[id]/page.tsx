...
const coursesData = [
  {
    ...
    description: "Aprenda desde os fundamentos até técnicas avançadas de preparo de café. Curso ideal para quem deseja se tornar um barista profissional.",
    duration: "40 horas",
    level: "intermediario",
    category: "barista",
    price: "R$ 1.200,00",
    ...
    fullDescription: "Torne-se um barista profissional com nosso curso mais completo. Você aprenderá desde os fundamentos da história e cultura do café até técnicas avançadas de extração, arte latte e atendimento ao cliente. O curso inclui aulas práticas intensivas com equipamentos profissionais de última geração.",
    requirements: [
      "Maior de 16 anos",
    ...
    schedule: [
      { week: "Semana 1-2", content: "Fundamentos e história do café, tipos de grãos, processos de torrefação" },
      { week: "Semana 3-4", content: "Equipamentos profissionais, calibração e manutenção" },
      { week: "Semana 5-6", content: "Técnicas de extração, dosagem e moagem perfeitas" },
      { week: "Semana 7-8", content: "Bebidas clássicas e criação de receitas autorais" },
      { week: "Semana 9-10", content: "Atendimento ao cliente e gestão de cafeteria" }
    ],
    instructorBio: "Chef Matteo Rossi é barista profissional há mais de 15 anos, com certificações internacionais da SCA (Specialty Coffee Association). Campeão de competições nacionais de latte art e consultor de diversas cafeterias premiadas.",
    reviews: [
      { name: "Maria Silva", rating: 5, comment: "Curso incrível! Aprendi muito mais do que esperava. O Chef Matteo é excelente!", date: "Há 2 semanas" },
      { name: "João Santos", rating: 5, comment: "Melhor investimento que fiz na minha carreira. Já estou trabalhando como barista!", date: "Há 1 mês" },
      { name: "Ana Costa", rating: 4, comment: "Muito bom! Conteúdo rico e aulas práticas excelentes.", date: "Há 2 meses" }
    ],
    certificate: true,
    materials: true,
    support: true,
  ...
  },
  {
    ...
    description: "Domine a arte de criar designs incríveis em suas bebidas. Do coração clássico a desenhos complexos.",
    duration: "20 horas",
    level: "iniciante",
    category: "arte-latte",
    price: "R$ 680,00",
    ...
    fullDescription: "Descubra a arte milenar do latte art e transforme cada xícara em uma obra de arte. Aprenda as técnicas corretas de vaporização do leite e domine desde desenhos básicos até criações complexas e autorais.",
    requirements: [
    ...
    schedule: [
      ...
      { week: "Semana 3", content: "Desenhos intermediários: rosetta e variações" },
      { week: "Semana 4", content: "Técnicas avançadas e criação autoral" }
    ],
    instructorBio: "Sofia Martins é especialista em latte art com mais de 8 anos de experiência. Medalhista em competições nacionais e internacionais, reconhecida por seu estilo criativo único.",
    reviews: [
      { name: "Pedro Lima", rating: 5, comment: "Sofia é uma excelente professora! Consegui fazer minha primeira rosetta perfeita!", date: "Há 1 semana" },
      { name: "Carla Mendes", rating: 5, comment: "Adorei o curso! Super didático e prático.", date: "Há 3 semanas" }
    ],
    certificate: true,
    materials: true,
    support: true,
  ...
  },
  {
    ...
    description: "Explore métodos como Aeropress, Chemex, V60, French Press e Sifão. Descubra o potencial único de cada método.",
    duration: "16 horas",
    level: "intermediario",
    category: "extracao",
    price: "R$ 560,00",
    ...
    fullDescription: "Mergulhe no fascinante mundo dos métodos alternativos de extração. Aprenda a dominar cada técnica e descubra como extrair o melhor sabor de cada tipo de café.",
    requirements: [
      "Conhecimento básico de café",
    ...
    instructorBio: "Ricardo Santos é Q-Grader certificado e especialista em métodos de extração, com experiência em consultoria para cafeterias especiais.",
    reviews: [
      { name: "Lucas Alves", rating: 5, comment: "Curso essencial para quem quer entender café de verdade!", date: "Há 2 semanas" }
    ],
    certificate: true,
    materials: true,
    support: true,
  ...
  },
  {
    ...
    description: "Workshop intensivo de um dia focado em dominar a arte do expresso perfeito.",
    duration: "8 horas",
    level: "iniciante",
    category: "barista",
    price: "R$ 320,00",
    ...
    fullDescription: "Workshop intensivo de um dia onde você aprenderá tudo sobre o preparo do expresso perfeito. Muita prática hands-on com equipamentos profissionais.",
    requirements: [
      "Interesse em café expresso"
    ],
    whatYouWillLearn: [
    ...
    instructorBio: "Chef Matteo Rossi é barista profissional há mais de 15 anos, com certificações internacionais da SCA.",
    reviews: [
      { name: "Beatriz Souza", rating: 5, comment: "Workshop excelente! Em um dia aprendi muito!", date: "Há 1 semana" }
    ],
    certificate: true,
    materials: true,
    support: false,
...
export default function CoursePage({ params }: { params: { id: string } }) {
  const [activeTab, setActiveTab] = useState<"sobre" | "conteudo" | "instrutor" | "avaliacoes">("sobre");
    ...
    <main className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <div className="text-background font-semibold">{course.instructor}</div>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="bg-background/10 backdrop-blur-sm rounded-2xl p-6 border border-background/20">
                ...
                <div className="mb-6">
                  <div className="text-background/80 text-sm mb-2">Investimento</div>
      ...
      <section className="max-w-[1400px] mx-auto px-4 py-12 sm:py-16">
        ...
        <div className="border-b border-accent/20 mb-8">
          <nav className="flex flex-wrap gap-2 -mb-px" aria-label="Navegação de conteúdo do curso">
            <button
              ...
              <div>
                ...
                <div className="space-y-4">
                  {course.schedule.map((item, index) => (
                    <div key={index} className="bg-accent/5 border border-accent/20 rounded-lg p-6 hover:border-accent/40 transition-colors">
                      <div className="flex items-start gap-4">
                        <div className="w-12 h-12 bg-accent/20 rounded-full flex items-center justify-center flex-shrink-0">
                          <span className="font-alumni text-xl font-bold text-accent">{index + 1}</span>
                        </div>
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            <details className="bg-background border border-accent/20 rounded-lg p-6 group">
              ...
              <p className="mt-4 text-foreground/70">
                Aceitamos cartão de crédito (parcelamento em até 12x sem juros), débito, PIX e transferência bancária. O pagamento pode ser feito no momento da inscrição.
              </p>
            </details>
            <details className="bg-background border border-accent/20 rounded-lg p-6 group">
              <summary className="font-semibold text-foreground cursor-pointer list-none flex items-center justify-between">
              ...
              <p className="mt-4 text-foreground/70">
                Sim, você tem até 7 dias corridos antes do início do curso para solicitar o cancelamento com reembolso integral.
              </p>
            </details>
            <details className="bg-background border border-accent/20 rounded-lg p-6 group">
              <summary className="font-semibold text-foreground cursor-pointer list-none flex items-center justify-between">
              ...
              <p className="mt-4 text-foreground/70">
                Sim, nossos certificados são reconhecidos nacionalmente e validados por associações de baristas e cafeterias.
              </p>
            </details>
            <details className="bg-background border border-accent/20 rounded-lg p-6 group">
              <summary className="font-semibold text-foreground cursor-pointer list-none flex items-center justify-between">
              ...
              <p className="mt-4 text-foreground/70">
                Depende do nível do curso. Cursos de nível iniciante não requerem experiência prévia. Para cursos intermediários e avançados, recomendamos conhecimento básico de café.
              </p>
            </details>
          </div>
        </div>
      ...
      {/* CTA Final */}
      <section id="inscricao" className="bg-gradient-to-br from-foreground via-accent to-foreground py-20">
        <div className="max-w-[1400px] mx-auto px-4 text-center">
          ...
          <p className="text-background/90 text-lg max-w-2xl mx-auto mb-8">
            Inscreva-se agora e garanta sua vaga no {course.title}. Vagas limitadas!
          </p>

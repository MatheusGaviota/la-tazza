...
export default function CursosPage() {
  ...
  const courses = [
    ...
    },
    {
      ...
      description: "Perfeito para iniciantes que querem entender o universo do café especial, desde a origem até a xícara.",
      duration: "12 horas",
      level: "iniciante",
      category: "degustacao",
      price: "R$ 420,00",
    ...
    },
    {
      ...
      description: "Aprenda a realizar sessões de cupping profissionais e desenvolva seu paladar para avaliar cafés especiais.",
      duration: "24 horas",
      level: "avancado",
      category: "degustacao",
      price: "R$ 890,00",
    ...
    },
    {
      ...
      description: "Aprenda a gerenciar sua própria cafeteria, desde o planejamento até operações do dia a dia.",
      duration: "32 horas",
      level: "intermediario",
      category: "gestao",
      price: "R$ 1.450,00",
    ...
    },
    {
      ...
      description: "Domine técnicas de extração a frio e crie bebidas refrescantes e inovadoras para seu cardápio.",
      duration: "16 horas",
      level: "intermediario",
      category: "extracao",
      price: "R$ 580,00",
    ...
    },
    {
      ...
      description: "Aprenda a arte da torrefação artesanal e desenvolva perfis de torra únicos para seus cafés.",
      duration: "28 horas",
      level: "avancado",
      category: "barista",
      price: "R$ 1.350,00",
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-foreground via-accent to-foreground py-20 sm:py-28 md:py-32">
        ...
        <div className="relative max-w-[1400px] mx-auto px-4 text-center">
          ...
          <p className="text-background/90 text-lg sm:text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed">
            Aprimore suas habilidades com nossos cursos profissionais ministrados por especialistas renomados no universo do café especial
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              ...
              onClick={() => document.getElementById('cursos-lista')?.scrollIntoView({ behavior: 'smooth' })}
            />
            <Button 
        ...
        <div className="max-w-[1400px] mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
            <div className="text-center">
              <div className="font-alumni text-4xl sm:text-5xl font-bold text-accent">1500+</div>
              <div className="text-foreground/70 mt-2">Alunos formados</div>
            </div>
            <div className="text-center">
              <div className="font-alumni text-4xl sm:text-5xl font-bold text-accent">25+</div>
              <div className="text-foreground/70 mt-2">Cursos disponíveis</div>
            </div>
            <div className="text-center">
              <div className="font-alumni text-4xl sm:text-5xl font-bold text-accent">4.8★</div>
              <div className="text-foreground/70 mt-2">Avaliação média</div>
            </div>
            <div className="text-center">
              <div className="font-alumni text-4xl sm:text-5xl font-bold text-accent">95%</div>
      ...
      <section id="cursos-lista" className="max-w-[1400px] mx-auto px-4 py-12 sm:py-16">
        <div className="mb-8 sm:mb-12">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            {(selectedCategory !== "todos" || selectedLevel !== "todos" || selectedType !== "todos") && (
              <button
                onClick={() => {
      ...
      <section className="bg-accent/10 border-y border-accent/20 py-16 sm:py-20">
        <div className="max-w-[1400px] mx-auto px-4 text-center">
          ...
          <p className="text-foreground/80 text-lg max-w-2xl mx-auto mb-8">
            Entre em contato conosco para criar um programa personalizado de acordo com suas necessidades específicas
          </p>
          <Button 

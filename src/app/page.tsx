  ...
  return (
    <main>
      ...
      <section className="w-full max-w-[1400px] mx-auto flex flex-col items-center px-4 py-10">
        ...
        <p className="sm:text-center text-base sm:text-lg text-foreground max-w-185 mt-3 px-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam rhoncus ante nulla, vitae faucibus orci tincidunt sit amet. Donec luctus sed leo non vestibulum.</p>

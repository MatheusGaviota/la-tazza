                ...
                {open && (
                    <div id="mobile-menu" className="md:hidden mt-2 pb-4">
                        <ul className="flex flex-col space-y-2 text-background">
                            ...
                            <li className="pt-2">
                                <Button text="Login" href="/login" variant="accent" className="w-full text-center" />
                            </li>
                            <li>
                                <Button text="Registro" href="/register" variant="ghost-accent" className="w-full text-center" />
                            </li>
                        </ul>
                    </div>
                )}

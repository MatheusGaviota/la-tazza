...
export default function CourseCard({ 
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 rounded-lg ring-2 ring-accent ring-offset-2 ring-offset-background opacity-0 transition-opacity duration-300 group-focus-within:opacity-100 pointer-events-none" aria-hidden="true" />
        </article>
    );
}
